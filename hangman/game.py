...
class Game:
    ...
    def generate_word(self) -> str:
        filename = "C:\\Users\\hp\\PycharmProjects\\Game_Hangman\\WordsStockRus.txt"
    ...
    def guess_letter(self, letter: str) -> Iterable[str]:
        if self.__tries_counter == self.__allowed_misses:
            raise InvalidOperationException(f'Exceed the max misses number. Allowed {self.allowed_misses}')
    ...
    def remaining_tries(self) -> int:
        return self.__allowed_misses - self.__tries_counter
